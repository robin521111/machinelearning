...
root = "D:/project/peixun/tesla/deep_tesla-master"
img_dir = os.path.abspath(root + '/images')
data_dir = os.path.abspath(root + '/epochs')
out_dir = os.path.abspath(root + '/output')
model_dir = os.path.abspath(root + '/models')
